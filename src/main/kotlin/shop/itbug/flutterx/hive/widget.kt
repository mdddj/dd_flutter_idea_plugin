package shop.itbug.flutterx.hive
...
import shop.itbug.flutterx.hive.component.HiveBoxListComponent
import shop.itbug.flutterx.hive.component.HiveValueComponent
...
class HiveWidget(project: Project, toolWindow: ToolWindow) : BorderLayoutPanel(), Disposable {
    ...
    private val toolbar = ActionManager.getInstance().createActionToolbar(
        ...
        (ActionManager.getInstance()
            .getAction("shop.itbug.flutterx.hive.action.HiveDefaultActionGroup") as DefaultActionGroup),
        true
    )
